        ...
        <div class="blog_left_sidebar">
          <article class="blog_item">
            <div class="blog_item_img">
              <img
                ...
                src="frontend/img/blog/single_blog_1.png"
                alt=""
              />
          ...
          <article class="blog_item">
            <div class="blog_item_img">
              <img
                class="card-img rounded-0"
                src="frontend/img/blog/single_blog_2.png"
                alt=""
              />
              <a href="#" class="blog_item_date">
                <h3>15</h3>
          ...
          <article class="blog_item">
            <div class="blog_item_img">
              <img
                class="card-img rounded-0"
                src="frontend/img/blog/single_blog_3.png"
                alt=""
              />
              <a href="#" class="blog_item_date">
                <h3>15</h3>
          ...
          <article class="blog_item">
            <div class="blog_item_img">
              <img
                class="card-img rounded-0"
                src="frontend/img/blog/single_blog_4.png"
                alt=""
              />
              <a href="#" class="blog_item_date">
                <h3>15</h3>
          ...
          <article class="blog_item">
            <div class="blog_item_img">
              <img
                class="card-img rounded-0"
                src="frontend/img/blog/single_blog_5.png"
                alt=""
              />
              <a href="#" class="blog_item_date">
                <h3>15</h3>
      ...
      <div class="col-lg-4">
        <div class="blog_right_sidebar">
          ...
          <aside class="single_sidebar_widget popular_post_widget">
            ...
            <div class="media post_item">
              <img src="frontend/img/post/post_4.png" alt="post" />
              <div class="media-body">
                <a href="single-blog.html">
            ...
            <ul class="instagram_row flex-wrap">
              <li>
                <a href="#">
                  <img
                    class="img-fluid"
                    src="frontend/img/post/post_5.png"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="#">
                  <img
                    class="img-fluid"
                    src="frontend/img/post/post_6.png"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="#">
                  <img
                    class="img-fluid"
                    src="frontend/img/post/post_7.png"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="#">
                  <img
                    class="img-fluid"
                    src="frontend/img/post/post_8.png"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="#">
                  <img
                    class="img-fluid"
                    src="frontend/img/post/post_9.png"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="#">
                  <img
                    class="img-fluid"
                    src="frontend/img/post/post_10.png"
                    alt=""
                  />
                </a>
              </li>
      ...
      <div class="row">
        <div class="col-xl-3 col-md-6 col-lg-3">
          <div class="footer_widget">
            <h3 class="footer_title">Join With Us</h3>
            <p class="footer_text doanar">
              <a class="first" href="#">Make Appointment</a> <br />
